        ...
        <a href='' className='item-a-box'>
          ...
          <div className='item-content'>
            ...
            <div className='item-price-box'>
              {/* 할인 유/무 여부 */}
              <div>{shoes.data[index].sale === true ? <p className='item-price-sale-on'>{shoes.data[index].price}</p> : <p className='item-price-sale-off'>{shoes.data[index].price}</p>}</div>
              {/* 정가 */}
            ...
            <div className='item-badge-box'>
              <span className='item-gender-box'>
                {shoes.data[index].gender === 'unisex' ? (
                  <>
                    <span className='male'>남</span>
                    <span className='female'>여</span>
                  </>
                ) : shoes.data[index].gender === 'male' ? (
                  <span className='male'>남</span>
                ) : (
                  <span className='female'>여</span>
                )}
              </span>
              <span className='item-coupon-box'>{shoes.data[index].coupon === true ? <span className='coupon'>쿠폰</span> : null}</span>
            </div>
          </div>
        </a>
      )}
