    ...
    <>
      <StyledHeader page={page}>
        <ul className='listContainer' ref={swipedTarget}>
          ...
          <li>
            <img src='https://images.unsplash.com/photo-1603796908893-e3472142232b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80' alt='헤더 슬라이드 이미지' />
            <div className='text'>
              <div className='textContainer'>
                <p>추석 연휴 특집 이벤트</p>
                <h2>
          ...
          <li>
            <img src='https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80' alt='헤더 슬라이드 이미지' />
            <div className='text'>
              <div className='textContainer'>
