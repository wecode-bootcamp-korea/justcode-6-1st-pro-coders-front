						...
						<tr>
							...
							<td>
								<ul>
									...
									<li>
										단, 배송 상품 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 경우에는 상품 등을 수령한 날부터 3개월 이내, 그 사실을 안 날
										또는 알 수 있었던 날부터 30일 이내
									</li>
								</ul>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<ul>
									...
									<li>
										반품 하실때는 부속품을 반드시 상품과 동시에 반송해 주십시오.(구매 명세서, 이너웨어 등의 패키지, 단추 등 상품의 부속품, 상품에 붙어 있는
										택·라벨)
									</li>
						...
						<tr>
							...
							<td>
								<ul>
									...
									<li>
										수선작업에 소요되는 기간은 평균적으로 고객센터 접수일(상품도착일)로부터 1주일 이내 또한 수선 작업이 어려운 경우 2주정도 작업이 완료됩니다.
										(단, 오래된 상품이나 수선자재를 구입하는 과정이 발생될 경우 지체될 수 있습니다.)
									</li>
								</ul>
							</td>
						</tr>
